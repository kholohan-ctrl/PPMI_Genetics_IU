...
workflow SmooveBatch {
  ...
  output {
    Array[File] smoove_vcfs = RunSmoove.vcf
    Array[File] smoove_vcf_indexes = RunSmoove.vcf_index
    Array[File] lumpy_command_scripts = RunSmoove.lumpy_cmd
  }
}
