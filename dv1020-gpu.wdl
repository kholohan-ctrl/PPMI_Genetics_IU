...
workflow DeepVariant {
    input {
        ...
        String r_zones = select_first([r_zones_override, "europe-west4-a europe-west4-b europe-west4-c"])
        String? deepvariant_docker_override
        # deepvariant 1.6.0 
        String deepvariant_docker = select_first([deepvariant_docker_override, "google/deepvariant:CL590726281-gpu"])
...
#      runtime_attr_default])
    RuntimeAttr runtime_attr = runtime_attr_default
    ...
    runtime {
      ...
      bootDiskSizeGb: 20 #runtime_attr.boot_disk_gb
...
#      default_attr])
  ...
  runtime {
      ...
      memory: 1 + " GiB"
      disks: "local-disk " +  runtime_attr.disk_gb + " SSD"
      bootDiskSizeGb: 10 #runtime_attr.boot_disk_gb
      preemptible: runtime_attr.preemptible_tries
      maxRetries: runtime_attr.max_retries
      zones: runtime_zones
  }
